...
def setup_argparse():
    ...
    #------Added RAM loading argument----
    parser.add_argument(
        '--ram_split',
        type=comma_separated_list,
        default=['train'],  # default: only load the training split into RAM
        help=('Comma-separated list of dataset splits to load into RAM. '
              'Options: train, test, valid, or use "all" to load all splits or "none" for none. '
              'For example, "--ram_split=test,valid"')
    )
